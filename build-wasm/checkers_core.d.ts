...
export interface InitOutput {
  ...
  readonly __wbg_mctsres_free: (a: number) => void;
  ...
  readonly game_set_method: (a: number, b: number) => void;
  ...
  readonly game_make_move_by_move_item: (a: number, b: number) => number;
  readonly game_best_move: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
  readonly game_mix_method: (a: number, b: number) => number;
  ...
  readonly game_mov_back: (a: number) => void;
  readonly game_move_by_tree_index_ts_n: (a: number, b: number) => number;
  readonly game_move_by_tree_index: (a: number, b: number) => number;
